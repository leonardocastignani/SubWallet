                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        icon: const Icon(CupertinoIcons.clear_thick_circled, color: CupertinoColors.systemGrey3, size: 26),
      ...
      child: Container(
        ...
        child: Image.network(
          ...
          errorBuilder: (context, error, stackTrace) {
            debugPrint("Errore caricamento immagine per $domain: $error");
            return const Icon(CupertinoIcons.globe, color: CupertinoColors.systemGrey);
          },
        ),
      ),
    ),
...
Widget _buildCustomServiceTile(BuildContext context) {
  return ListTile(
    ...
    leading: Container(
      ...
      child: const Icon(CupertinoIcons.pen, color: Color(0xFF007AFF)),
    ),
    title: const Text(
      'Crea personalizzato',
      style: TextStyle(
    ...
    subtitle: const Text(
      'Aggiungi un servizio non in lista',
