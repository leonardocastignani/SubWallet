...
void showCategoryChartModal(BuildContext context, List<QueryDocumentSnapshot> subscriptions) {
  showModalBottomSheet(
    ...
    builder: (context) => _CategoryChartModalContent(subscriptions: subscriptions),
  );
}
...
class _CategoryChartModalContentState extends State<_CategoryChartModalContent> {
      ...
      child: Column(
        children: [
          ...
          const Padding(
            ...
            child: Text('Spesa per Categoria', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, letterSpacing: -0.5)),
          ),
                      ...
                      children: [
                        ...
                        PieChart(
                          PieChartData(
                            ...
                            sections: _buildChartSections(sortedCategories, grandTotal),
                          ),
                        ),
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: selectedColor, letterSpacing: 0.5),
                              ),
                            ),
                            const SizedBox(height: 6),
                            Text(
                              '€${selectedCategoryValue.toStringAsFixed(2)}',
  ...
  List<PieChartSectionData> _buildChartSections(List<MapEntry<String, double>> sortedCategories, double grandTotal) {
