    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Padding(padding: EdgeInsets.symmetric(vertical: 12), child: Text('Classifica per costo', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, letterSpacing: -0.5))),
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Row(children: [Icon(CupertinoIcons.list_number, color: CupertinoColors.systemPink, size: 20), SizedBox(width: 8), Text('Impatto sul portafoglio', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: CupertinoColors.systemGrey))]),
                ...
                const Row(children: [Icon(CupertinoIcons.sort_down, color: CupertinoColors.systemPink, size: 18), SizedBox(width: 6), Text('DAL PIÙ CARO AL PIÙ ECONOMICO', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: CupertinoColors.systemGrey, letterSpacing: 1.2))]),
                const SizedBox(height: 12),

                if (_rankedSubscriptions.isEmpty)
                  const Padding(padding: EdgeInsets.all(24.0), child: Center(child: Text('Nessun abbonamento da classificare.', style: TextStyle(color: CupertinoColors.systemGrey))))
                else
                  Container(
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(item['name'], style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600)), const SizedBox(height: 2), Text(item['category'], style: const TextStyle(fontSize: 13, color: CupertinoColors.systemGrey))])),
                                  Column(
