            ...
            _buildSectionContainer(
              children: [
                _buildSettingsTile(
                  ...
                  subtitle: 'Avvisa 1/3/7 giorni prima della scadenza',
                ),
                _buildSettingsTile(
                  icon: CupertinoIcons.doc_text_fill,
                  iconColor: CupertinoColors.systemYellow,
                  title: 'Report mensile',
                  subtitle: 'Riepilogo spese all\'inizio di ogni mese',
                ),
                _buildSettingsTile(
                  icon: CupertinoIcons.exclamationmark_triangle_fill,
                  iconColor: CupertinoColors.destructiveRed,
                  title: 'Soglia di budget',
                  subtitle: 'Notifica se la spesa supera una soglia',
                  isLast: true,
                ),
              ],
            ),
            ...
            _buildSectionContainer(
              children: [
                ...
                _buildSettingsTile(
                  ...
                  subtitle: 'Nasconde importi nelle schermate',
                  isLast: true,
