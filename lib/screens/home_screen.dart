    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('Nessun abbonamento', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, letterSpacing: -0.5)),
          const SizedBox(height: 8),
          const Text('Aggiungi il tuo primo abbonamento\nper iniziare a tracciarlo.', textAlign: TextAlign.center, style: TextStyle(fontSize: 15, color: CupertinoColors.systemGrey, height: 1.3)),
        ],
      ),
    );
  }
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(data['serviceName'] ?? 'Sconosciuto', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, letterSpacing: -0.5)),
                  const SizedBox(height: 4),
                  Text(cycle, style: const TextStyle(fontSize: 14, color: CupertinoColors.systemGrey)),
                ],
              ),
            ),
            Text('€${price.toStringAsFixed(2)}', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Color(0xFF007AFF))),
          ],
        ),
      ),
    );
